...
export const allLinks = [
  ...
  { href: "/carreras", label: "Carreras", icon: BookOpenCheck, roles: ['administrador'], exact: true },
  { href: "/coordinador-carreras", label: "Carreras", icon: BookOpenCheck, roles: ['coordinador'], exact: true },
  { href: "/materias", label: "Materias", icon: BookCopy, roles: ['administrador'], exact: true },
  { href: "/coordinador-materias", label: "Materias", icon: BookCopy, roles: ['coordinador'], exact: true },
