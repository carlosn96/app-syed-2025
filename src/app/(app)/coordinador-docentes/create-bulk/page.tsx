...
/**
 * Página para creación masiva de docentes (contexto coordinador)
 * Solo accesible para administradores
 */
export default function CreateBulkDocentesCoordinadorPage() {
        ...
        <Card className="border-amber-200 bg-amber-50/50 dark:bg-amber-950/20">
          <CardHeader>
            ...
            <CardDescription className="text-amber-700 dark:text-amber-300">
              ...
              Los coordinadores pueden crear docentes individualmente desde la sección de gestión de docentes.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
              onClick={() => router.push('/coordinador-docentes')}
              className="gap-2"
            >
